...
DM, NP, SEQ, BS, AE = 768, 4096, 64, 8, 2
EPOCHS, LR = 10, 3e-4
N_SEGMENTS = 200000
SUBSAMPLE = 8
CKPT, CKPT_NAME = "checkpoints", "cann_15m_wt103"
...
if os.path.exists(CKPT_RESUME):
    ...
    # Reset LR schedule for remaining epochs (cosine warm-restart)
