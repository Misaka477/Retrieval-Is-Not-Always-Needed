"""CANN-SSM 15M ablation: attract_every=9999 (no attractor, SSM-only)."""
...
DM, NP, SEQ, BS, AE = 768, 4096, 64, 8, 9999  # 9999 = no attractor
EPOCHS, LR = 10, 3e-4
N_SEGMENTS = 200000
SUBSAMPLE = 8
CKPT, CKPT_NAME = "checkpoints", "cann_15m_abl"
...
print(f"Model (d={DM}, np={NP}, attract_every={AE})...", flush=True)
