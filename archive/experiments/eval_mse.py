...
import os,torch; os.environ['PYTORCH_CUDA_ALLOC_CONF']='expandable_segments:True'
import torch.nn as nn, torch.nn.functional as F
sys.path.insert(0,'.'); from rina.model import _load_wkv7; _load_wkv7()
...
class Cmix(nn.Module):
    def __init__(self):
        super().__init__(); C=D
        self.x_k=nn.Parameter(torch.empty(1,1,C)); self.key=nn.Linear(C,C*4,bias=False)
