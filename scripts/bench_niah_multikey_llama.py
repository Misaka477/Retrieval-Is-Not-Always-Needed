"""LLaMA 3.2 1B on multi-key NIAH (seq=1024, native training length)."""
...
print(f"LLaMA 3.2 1B — multi-key NIAH ({N_KEYS} keys, gap={GAP}, seq={SEQ})")
...
print(f"\n  LLaMA 3.2 1B (seq=1024) multi-key ({N_KEYS}, gap={GAP}): {acc*100:.0f}%")
